...
builder.Services.AddScoped<Master.Services.Interfaces.IUserService, Master.Services.UserService>();
builder.Services.AddScoped<Master.Services.Data.IUserRepository, Master.Services.Data.UserRepository>();
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.File("logs/UserService-.log", rollingInterval: RollingInterval.Day) // Add file sink
    .CreateLogger();
